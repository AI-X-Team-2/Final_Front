import apple from "./word-audio/apple.mp4";
import banana from "./word-audio/banana.mp4";
import car from "./word-audio/car.mp4";
import hippo from "./word-audio/hippo.mp4";
import milk from "./word-audio/milk.mp4";
import pizza from "./word-audio/pizza.mp4";
import potato from "./word-audio/potato.mp4";
import rabbit from "./word-audio/rabbit.mp4";
import radio from "./word-audio/radio.mp4";
import school from "./word-audio/school.mp4";
...
import step1_2_2 from "./STEP 1-5 video/STEP1/step1_2-2.mp4";
import step1_2_3 from "./STEP 1-5 video/STEP1/step1_2-3.mp4";
import step1_2_4 from "./STEP 1-5 video/STEP1/step1_2-4.mp4";
...
export const step1Words = {
  step1_1: [
    ...
    { word: "비", videoPath: step1_1_3 },
    { word: "배", videoPath: step1_1_4 },
    { word: "뱨", videoPath: step1_1_5 },
  ],
  step1_2: [
    { word: "파", videoPath: step1_2_1 },
    { word: "퍄", videoPath: step1_2_2 },
    { word: "피", videoPath: step1_2_3 },
    { word: "패", videoPath: step1_2_4 },
    { word: "퍠", videoPath: step1_2_5 },
  ],
  step1_3: [
    { word: "파", videoPath: step1_3_1 },
    { word: "퍄", videoPath: step1_3_2 },
    { word: "피", videoPath: step1_3_3 },
    { word: "패", videoPath: step1_3_4 },
    { word: "퍠", videoPath: step1_3_5 },
  ],
};
...
export const step2Words = {
  step2_1: [
    ...
    { word: "디", videoPath: step2_1_3 },
    { word: "대", videoPath: step2_1_4 },
    { word: "뎨", videoPath: step2_1_5 },
    { word: "더", videoPath: step2_1_6 },
    { word: "뎌", videoPath: step2_1_7 },
    { word: "데", videoPath: step2_1_8 },
    { word: "돼", videoPath: step2_1_9 },
  ],
  step2_2: [
    { word: "나", videoPath: step2_2_1 },
    { word: "냐", videoPath: step2_2_2 },
    { word: "니", videoPath: step2_2_3 },
    { word: "내", videoPath: step2_2_4 },
    { word: "냬", videoPath: step2_2_5 },
    { word: "너", videoPath: step2_2_6 },
    { word: "녀", videoPath: step2_2_7 },
    { word: "네", videoPath: step2_2_8 },
    { word: "녜", videoPath: step2_2_9 },
  ],
  step2_3: [
    { word: "라", videoPath: step2_3_1 },
    { word: "랴", videoPath: step2_3_2 },
    { word: "리", videoPath: step2_3_3 },
    { word: "래", videoPath: step2_3_4 },
    { word: "럐", videoPath: step2_3_5 },
    { word: "러", videoPath: step2_3_6 },
    { word: "려", videoPath: step2_3_7 },
    { word: "레", videoPath: step2_3_8 },
    { word: "례", videoPath: step2_3_9 },
  ],
  step2_4: [
    { word: "사", videoPath: step2_4_1 },
    { word: "샤", videoPath: step2_4_2 },
    { word: "시", videoPath: step2_4_3 },
    { word: "새", videoPath: step2_4_4 },
    { word: "섀", videoPath: step2_4_5 },
    { word: "서", videoPath: step2_4_6 },
    { word: "셔", videoPath: step2_4_7 },
    { word: "세", videoPath: step2_4_8 },
    { word: "셰", videoPath: step2_4_9 },
  ],
};
...
export const step3Words = {
  step3_1: [
    ...
    { word: "지", videoPath: step3_1_3 },
    { word: "재", videoPath: step3_1_4 },
    { word: "쟤", videoPath: step3_1_5 },
    { word: "저", videoPath: step3_1_6 },
    { word: "져", videoPath: step3_1_7 },
    { word: "제", videoPath: step3_1_8 },
    { word: "졔", videoPath: step3_1_9 },
    { word: "즈", videoPath: step3_1_10 },
    { word: "즤", videoPath: step3_1_11 },
  ...
  step3_2: [
    ...
    { word: "찌", videoPath: step3_2_3 },
    { word: "째", videoPath: step3_2_4 },
    { word: "쨰", videoPath: step3_2_5 },
    { word: "쩌", videoPath: step3_2_6 },
    { word: "쪄", videoPath: step3_2_7 },
    { word: "쩨", videoPath: step3_2_8 },
    { word: "쪠", videoPath: step3_2_9 },
    { word: "쯔", videoPath: step3_2_10 },
    { word: "쯰", videoPath: step3_2_11 },
    { word: "쪼", videoPath: step3_2_12 },
    { word: "쬬", videoPath: step3_2_13 },
  ],
  step3_3: [
    { word: "차", videoPath: step3_3_1 },
    { word: "챠", videoPath: step3_3_2 },
    { word: "치", videoPath: step3_3_3 },
    { word: "채", videoPath: step3_3_4 },
    { word: "챼", videoPath: step3_3_5 },
    { word: "처", videoPath: step3_3_6 },
    { word: "쳐", videoPath: step3_3_7 },
    { word: "체", videoPath: step3_3_8 },
    { word: "쳬", videoPath: step3_3_9 },
    { word: "츠", videoPath: step3_3_10 },
    { word: "츼", videoPath: step3_3_11 },
    { word: "초", videoPath: step3_3_12 },
    { word: "쵸", videoPath: step3_3_13 },
  ]
};
...
export const step4Words = {
  step4_1: [
    ...
    { word: "고", videoPath: step4_1_3 },
    { word: "교", videoPath: step4_1_4 },
    { word: "괴", videoPath: step4_1_5 },
    { word: "괘", videoPath: step4_1_6 },
    { word: "과", videoPath: step4_1_7 },
    { word: "구", videoPath: step4_1_8 },
    { word: "규", videoPath: step4_1_9 },
    { word: "귀", videoPath: step4_1_10 },
    { word: "궈", videoPath: step4_1_11 },
    { word: "궤", videoPath: step4_1_12 },
  ],
  step4_2: [
    { word: "크", videoPath: step4_2_1 },
    { word: "킈", videoPath: step4_2_2 },
    { word: "코", videoPath: step4_2_3 },
    { word: "쿄", videoPath: step4_2_4 },
    { word: "쾨", videoPath: step4_2_5 },
    { word: "쾌", videoPath: step4_2_6 },
    { word: "콰", videoPath: step4_2_7 },
    { word: "쿠", videoPath: step4_2_8 },
    { word: "큐", videoPath: step4_2_9 },
    { word: "퀴", videoPath: step4_2_10 },
    { word: "쿼", videoPath: step4_2_11 },
    { word: "퀘", videoPath: step4_2_12 },
  ],
  step4_3: [
    { word: "으", videoPath: step4_3_1 },
    { word: "읫", videoPath: step4_3_2 },
    { word: "오", videoPath: step4_3_3 },
    { word: "요", videoPath: step4_3_4 },
    { word: "외", videoPath: step4_3_5 },
    { word: "왜", videoPath: step4_3_6 },
    { word: "와", videoPath: step4_3_7 },
    { word: "우", videoPath: step4_3_8 },
    { word: "유", videoPath: step4_3_9 },
    { word: "위", videoPath: step4_3_10 },
    { word: "워", videoPath: step4_3_11 },
    { word: "웨", videoPath: step4_3_12 },
  ]
};
...
export const step5Words = {
  step5_1: [
    ...
    { word: "히", videoPath: step5_1_3 },
    { word: "해", videoPath: step5_1_4 },
    { word: "햬", videoPath: step5_1_5 },
    { word: "허", videoPath: step5_1_6 },
    { word: "혀", videoPath: step5_1_7 },
    { word: "헤", videoPath: step5_1_8 },
    { word: "혜", videoPath: step5_1_9 },
  ],
  step5_2: [
    { word: "흐", videoPath: step5_2_1 },
    { word: "희", videoPath: step5_2_2 },
    { word: "호", videoPath: step5_2_3 },
    { word: "효", videoPath: step5_2_4 },
    { word: "회", videoPath: step5_2_5 },
    { word: "홰", videoPath: step5_2_6 },
